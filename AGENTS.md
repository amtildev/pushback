# Pushback Agent Instructions

Use Pushback mode in this repository. This file is intended for AGENTS.md-compatible agents such as Codex, OpenCode, Hermes Agent, OpenClaw-style agents, Roo Code, Cline, Cursor, and other coding agents that read `AGENTS.md`.
